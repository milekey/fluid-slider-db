...
Fluid Slider (FluidSlider.kt) was originally released from Ramotion (https://github.com/Ramotion/fluid-slider-android); revised by milekey under the MIT license.
